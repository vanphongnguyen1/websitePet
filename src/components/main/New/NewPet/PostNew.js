      ...
      <div className="container post-new">
        ...
        <div className="entry-content">
            ...
            <>
              ...
              <div className="entry-content__box-image">
                <img
                  src={item.img}
                  alt=""
                  className="entry-content__box-image--img"
                />
                <p className="entry-content__box-image--text-sub">
                  {item.title}
                </p>
              </div>

              {item.text2 && (
                <p className="entry-content__text">{item.text2}</p>
              )}

              {item.text3 && (
                <p className="entry-content__text">{item.text3}</p>
              )}
              ...
              {item.concastInfo.phone && (
                <p className="entry-content__text">
                  Hotline:&nbsp;
                  <a
                    href={`tel:${item.concastInfo.phone}`}
                    className="entry-content__text--link"
                  >
                    {item.concastInfo.phone}
                  </a>
                </p>
              ...
              {item.concastInfo.email && (
                <p className="entry-content__text">
                  Email:&nbsp;
                  <a
                    href={`mailto:${item.concastInfo.email}`}
                    className="entry-content__text--link"
                  >
                    {item.concastInfo.email}
                  </a>
              ...
              {item.concastInfo.facebook && (
                <p className="entry-content__text">
                  Facebook:&nbsp;
                  <a
                    href={item.concastInfo.facebook}
                    className="entry-content__text--link"
                  >
                    {item.concastInfo.facebook}
                  </a>
          ...
          <div className="entry-box">
            <p className="entry-content__text">
              Hy vọng qua những gợi ý trên đây, các bạn có thể chọn được cửa
              hàng bán chó cảnh uy tín phù hợp với nhu cầu của mình tại Hà Nội.
              Còn nếu bạn đang ở thành phố mang tên Bác, không vấn đề gì vì
              chúng tôi cũng có danh sách Top 10 cửa hàng bán chó cảnh uy tín
              nhất Hồ Chí Minh. Chúc mọi người sớm tìm được Boss của đời mình
              nhé.
            </p>
